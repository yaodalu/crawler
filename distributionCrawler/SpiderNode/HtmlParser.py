...
class HtmlParser(object):
    ...
    def parser(self,page_url,html_cont):
        ...
        if page_url is None or html_cont is None:
            return
        soup = BeautifulSoup(html_cont,'lxml')#html.parser是Python自带的解析库
...
if __name__ == "__main__":
    ...
    parser = HtmlParser()
    page_url = 'http://baike.baidu.com/view/284853.html'
    html_cont = downloader.download(page_url)
    print parser.parser(page_url,html_cont)
